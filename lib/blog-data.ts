...
export const blogPosts: BlogPost[] = [
	{
		id: 1,
		title:
			'A Simple Guide to Building a Highly Available 3-Tier Architecture on AWS',
		description:
			'In this guide, I will walk through the process of building a highly available 3-tier architecture on AWS...',
		author: 'Catherine Vuthi',
		datePosted: 'Feb 5, 2026',
		url: 'https://medium.com/@vuthi.esther/a-simple-guide-to-building-a-highly-available-3-tier-architecture-on-aws-72b9d1bf2988',
	},
	{
		id: 2,
